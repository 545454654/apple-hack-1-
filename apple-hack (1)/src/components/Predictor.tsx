...
export default function Predictor({ userId }: PredictorProps) {
  ...
  const renderWholeApple = () => (
    <svg viewBox="0 0 100 100" className="w-[85%] h-[85%] drop-shadow-[0_0_12px_rgba(57,255,20,0.65)]">
      <defs>
        <radialGradient id="greenBgGrad" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#1dd1a1"/>
          <stop offset="70%" stopColor="#10ac84"/>
      ...
      {/* Outer Badge Circle */}
      <circle cx="50" cy="50" r="45" fill="url(#greenBgGrad)" stroke="#39ff14" strokeWidth="2.5" />
  ...
  const renderBittenApple = () => (
    <svg viewBox="0 0 100 100" className="w-[85%] h-[85%] drop-shadow-[0_0_12px_rgba(255,51,102,0.65)]">
      <defs>
        <radialGradient id="redBgGrad" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#c0392b"/>
          <stop offset="70%" stopColor="#7b241c"/>
      ...
      {/* Outer Badge Circle */}
      <circle cx="50" cy="50" r="45" fill="url(#redBgGrad)" stroke="#ff3366" strokeWidth="2.5" />
      ...
      <div className="w-full flex justify-between items-center bg-cyber-card border border-[#00f7ff]/20 rounded-2xl px-4 py-3 mb-4 neon-shadow-cyan">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-8 h-8 rounded-lg bg-[#001018] border border-[#00f7ff]/20 flex items-center justify-center text-[#00f7ff] hover:bg-[#00f7ff]/10 hover:border-[#00f7ff] transition-all cursor-pointer"
          >
